function [traindata, rann] = sampling_3c_revise(Vm, Um, para0)
...
for i=1:sn
    ...
    elseif ran == 2
        ...
        y0 = - Um(i)*0.3*cos(0.8*t + 4.5) - 0.2;  
        w1 = para0(1); a1 = para0(2); v1 = para0(3); v0 = para0(4);          
    else
        y0 = Um(i)*0.8*atan(0.6*t);
...
w1 = unifrnd(0.1,2.0,1,1);
a1 = unifrnd(0.1,2.0,1,1);
v1 = unifrnd(0.1,2.0,1,1);
v0 = 9e-10;
